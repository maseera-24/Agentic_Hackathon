          ...
          <div className="bg-[#151C32] w-full max-w-md rounded-2xl border border-[#27324A] p-6 space-y-5 animate-scaleIn text-[#F8FAFC] text-xs shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div className="text-[11px] text-[#94A3B8] pt-1">
                Applied on: {appDate(selectedApp.applied_at)} &middot; Resume: <span className={selectedApp.resume_filename ? 'text-[#4ADE80]' : 'text-amber-400'}>{selectedApp.resume_filename || 'Not Uploaded'}</span>
              </div>
            </div>
