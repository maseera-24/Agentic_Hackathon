...
# Add Ch Venkata Student Account
STUDENTS_SEED.append({
    "id": "STU1280",
    "name": "Ch Venkata",
    "email": "pavankumar.1280@gmail.com",
    "phone": "+91 98765 41280",
    "branch": "Computer Science & Engineering",
    "department": "School of Computer Engineering",
    "cgpa": 8.75,
    "backlogs": 0,
    "graduation_year": 2026,
    "technical_skills": ["Python", "Java", "Data Structures", "Algorithms", "SQL", "React", "FastAPI", "Docker"],
    "preferred_skills": ["Kubernetes", "AWS", "Machine Learning"],
    "certifications": ["AWS Certified Solutions Architect", "HackerRank 6-Star Problem Solving"],
    "projects": [
        {"title": "Agentic Placement Management Platform", "tech": ["Python", "React", "FastAPI", "MongoDB"], "description": "Autonomous campus placement operations and interview scheduler system."},
        {"title": "Distributed Cloud Microservices", "tech": ["Docker", "FastAPI", "PostgreSQL"], "description": "High-availability microservice backend handling concurrent workloads."}
    ],
    "resume_url": None,
    ...
    "coding_score": 95,
    "communication_score": 88,
    "previous_drives": ["Google (Applied)", "Microsoft (Shortlisted)"],
    "placement_status": "Seeking Dream Offer",
    "readiness": {
        "overall": 92,
        "roles": {"Software Engineer": 95, "Data Analyst": 88, "Cloud Engineer": 92},
        "breakdown": {"Technical": 95, "DSA": 96, "Aptitude": 92, "Communication": 88, "Resume": 85}
    },
    "attendance_confirmed": True
})
